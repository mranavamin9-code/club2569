<?php
	...
	header("Content-Disposition: attachment; filename=รายงานข้อมูลกิจกรรมชุมนุม.doc");
?>
...
?>
<div align="center"><b><font size="6" face="MS Sans Serif, Tahoma, sans-serif">รายงานข้อมูลกิจกรรมชุมนุม</font><br><font size="5" face="MS Sans Serif, Tahoma, sans-serif"></font></b></div><br>
<table align="center" width="100%" border="1" cellspacing="0" cellpadding="0" style="border-collapse:collapse;">
  <tr align="center">
    <td width="43" height="26" bgcolor="#EEEEEE"><font size="2">ลำดับ</font></td>
    <td width="208" bgcolor="#EEEEEE"><font size="2" face="MS Sans Serif, Tahoma, sans-serif">ชื่อกิจกรรมชุมนุม</font></td>
    <td width="97" bgcolor="#EEEEEE"><font size="2" face="MS Sans Serif, Tahoma, sans-serif">คาบเรียน</font></td>
    <td width="108" bgcolor="#EEEEEE"><font size="2" face="MS Sans Serif, Tahoma, sans-serif">คุณสมบัติ<br />
      ผู้เรียน</font></td>
    <td width="46" bgcolor="#EEEEEE"><font size="2" face="MS Sans Serif, Tahoma, sans-serif">จ.น.<br />
      ที่รับ</font></td>
    <td width="43" bgcolor="#EEEEEE"><font size="2" face="MS Sans Serif, Tahoma, sans-serif">รับแล้ว</font></td>
    <td width="210" bgcolor="#EEEEEE"><font size="2" face="MS Sans Serif, Tahoma, sans-serif">ครูผู้สอน</font></td>
    <td width="154" bgcolor="#EEEEEE"><font size="2" face="MS Sans Serif, Tahoma, sans-serif">สถานที่<br />
    จัดกิจกรรม</font></td>
    <td width="34" bgcolor="#EEEEEE"><font size="2" face="MS Sans Serif, Tahoma, sans-serif">ระดับ<br>ชั้น</font></td>
    <td width="36" bgcolor="#EEEEEE"><font size="2" face="MS Sans Serif, Tahoma, sans-serif">ปีการ<br>ศึกษา</font></td>
    <td width="90" bgcolor="#EEEEEE"><font size="2" face="MS Sans Serif, Tahoma, sans-serif">สถานะ</font></td>
  </tr>
<?php 
		$i =0;	//ตัวเช็ควนรอบ
...
?>
  <tr>
    <td width="43" height="30" align="center" valign="top"><font size="2" face="MS Sans Serif, Tahoma, sans-serif"><?php echo $a;?></font></td>
    <td width="208" valign="top"><font size="2" face="MS Sans Serif, Tahoma, sans-serif"><?php echo $dep_id;?> <?php echo $name_dep;?></font></td>
    <td align="center" valign="top"><font size="2" face="MS Sans Serif, Tahoma, sans-serif"><?php echo $period;?></font></td>
    <td width="108" valign="top"><font size="2" face="MS Sans Serif, Tahoma, sans-serif"><?php echo $atd;?></font></td>
    <td width="46" align="center" valign="top"><font size="2" face="MS Sans Serif, Tahoma, sans-serif"><?php echo $number;?></font></td>
    <td width="43" align="center" valign="top"><font size="2" face="MS Sans Serif, Tahoma, sans-serif">
<?php
	//ดึงค่าจำนวนออกมา
...
?>
    ...
    <td width="210" align="center" valign="top"><font size="2" face="MS Sans Serif, Tahoma, sans-serif">
...
?>
    ...
    <td width="154" valign="top"><font size="2" face="MS Sans Serif, Tahoma, sans-serif"><?php echo $classroom;?></font></td>
    <td width="34" align="center" valign="top"><font size="2" face="MS Sans Serif, Tahoma, sans-serif"><?php echo $class;?></font></td>
...
?>
    ...
    <td width="90" align="center" valign="top"><font size="2" face="MS Sans Serif, Tahoma, sans-serif">
<?php
