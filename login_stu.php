...
<table width="1100" border="0" align="center" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
  <tr>
    <td><table width="100%" bgcolor="#FFFFFF" border="0" align="center" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
      ...
      <tr>
        <td>
        <form name="form_login" method="post" action="check_stu.php">
        <table width="100%" height="500" border="0" cellspacing="0" cellpadding="0" background="images/pic/bg_stu.jpg">
          <tr>
            <td width="56%" height="91" valign="top">&nbsp;</td>
          ...
          <tr>
            ...
            <td height="58" valign="top">&nbsp;</td>
            <td valign="middle"><div class="form-group has-feedback" style="width:250px;">
            <input name="uname" type="text" placeholder="รหัสนักเรียน" class="form-control css-require" />
            </div></td>
            </tr>
          <tr>
            <td height="58" valign="top">&nbsp;</td>
          ...
          <tr>
            ...
            <td height="53" valign="top">&nbsp;</td>
            <td valign="top"><button type="submit" name="button" id="button" class="btn btn-primary"><img src="images/log.png" width="20" height="24" align="absmiddle" />&nbsp;&nbsp; เข้าสู่ระบบ &nbsp;&nbsp;</button></td>
            </tr>
          <tr>
