...
<body>
<div align="center"><font size="5" face="MS Sans Serif, Tahoma, sans-serif" color="#FF6600"><b>เพิ่มข้อมูลนักเรียน</b></font></div>
<form name="form_edit" method="post" action="save_stu_new.php">
  ...
  <tr>
    <td width="29%" height="25" valign="middle" bgcolor="#EEF1FD"><font size="3" face="MS Sans Serif, Tahoma, sans-serif">เลขประจำตัวนักเรียน :</font></td>
...
?>
  ...
  <tr>
    <td height="25" valign="middle" bgcolor="#EEF1FD">&nbsp;</td>
    <td height="25" valign="middle" bgcolor="#EEF1FD"><font size="3" face="MS Sans Serif, Tahoma, sans-serif">
    <input type="radio" name="status_stu" value="1" />ยืนยันการเพิ่มข้อมูล</font>
    <font size="3" face="MS Sans Serif, Tahoma, sans-serif" color="#FF0000">*</font></td>
  </tr>
  <tr>
    <td height="25" align="center" bgcolor="#EEF1FD">&nbsp;</td>
    <td height="25" bgcolor="#EEF1FD">
    <img src="captcha/captcha_img.php"><br>
  	<input name="capt" type="text" class="txt_box" placeholder="ระบุตัวอักษรตามภาพ">&nbsp;<font size="2" face="MS Sans Serif, Tahoma, sans-serif" color="#FF0000">*กรุณาระบุตัวอักษรตามภาพให้ถูกต้อง</font>
    </td>
  </tr>
  <tr>
    <td height="58" align="center">&nbsp;</td>
    <td height="58"><button type="submit" name="submit" value="submit" style="height:30px; font-size:15px;"><img src="images/save.png" width="24" height="24" align="absmiddle" /> บันทึกข้อมูล</button></td>
  </tr>
  </table>
</form>
</body>
