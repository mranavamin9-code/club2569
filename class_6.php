...
function con_del(){
if (confirm("ยืนยันการปรับสถานะนักเรียน ?") ==true){
return true;
}
return false;
}
...
<?php
	...
	{
?>
<div align="center"><font size="6" face="MS Sans Serif, Tahoma, sans-serif"><b>เลื่อนระดับชั้นนักเรียน มัธยมศึกษาปีที่ 6 &gt; จบการศึกษา</b></font></div>
<br>
<?php
//*** Update Condition ***//
if($_GET["Action"] == "Save")
...
$strSQL = "SELECT * FROM tb_student where class_id ='6' and status_stu ='1' ORDER BY stu_id ASC";
$objQuery = mysql_query($strSQL) or die ("Error Query [".$strSQL."]");
?>

<form name="frmMain" method="post" action="class_6.php?Action=Save">
...
<table width="20%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <input type="submit" name="submit" value="ปรับสถานะนักเรียน" id="submit" onclick="return con_del()" style="height: 30px; font-size: 15px; width: 150px;">
