...
<?php
	...
	{
?>
<div align="center"><font size="6" face="MS Sans Serif, Tahoma, sans-serif"><b>เลื่อนระดับชั้นนักเรียน มัธยมศึกษาปีที่ 3 &gt; จบการศึกษา</b></font></div>
<br>
<?php
//*** Update Condition ***//
if($_GET["Action"] == "Save")
...
$strSQL = "SELECT * FROM tb_student where class_id ='3' and status_stu ='1' ORDER BY stu_id ASC";
$objQuery = mysql_query($strSQL) or die ("Error Query [".$strSQL."]");
?>

<form name="frmMain" method="post" action="class_3.php?Action=Save">
