...
<?php	
		...
		$sql = "SELECT * FROM  tb_department where dep_id like '%$id%' and name_dep like '%$namedep%' and ty_id like '%$ty%' and class like '%$class_stu%' and status_dep like '%$status%' order by d_id desc";
...
<table align="center" width="1500" border="1" cellspacing="0" cellpadding="0" style="border-collapse:collapse;">
  <tr align="center">
    ...
    <td width="306" bgcolor="#EAEAEA"><font size="2">ชื่อกิจกรรมชุมนุม</font></td>
    <td width="155" bgcolor="#EAEAEA"><font size="2">คาบเรียน</font></td>
    ...
    <td width="193" bgcolor="#EAEAEA"><font size="2">สถานที่<br />
    จัดกิจกรรม</font></td>
    <td width="72" bgcolor="#EAEAEA"><font size="2">ระดับ<br>ชั้น</font></td>
...
?>
  <tr>
    ...
    <td width="155" valign="top"><font size="2" face="MS Sans Serif, Tahoma, sans-serif"><?php echo $period;?></font></td>
...
?>
    ...
    <td width="193" valign="top"><font size="2" face="MS Sans Serif, Tahoma, sans-serif"><?php echo $classroom;?></font></td>
    <td width="72" align="center" valign="top"><font size="2" face="MS Sans Serif, Tahoma, sans-serif"><?php echo $class;?></font></td>
