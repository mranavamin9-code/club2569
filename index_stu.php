    ...
    <table width="100%" height="800" border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse;">
      ...
      <tr>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><marquee scrollamount="5" direction="left"><b>หน้าแรกส่วนของนักเรียน :: <?=config_title;?></b></marquee><br></td>
          </tr>
          <tr>
...
?>
              <font size="3"><b><?php echo '&nbsp;&nbsp;'."$student_id".'&nbsp;'.":".'&nbsp;'."$stu_name".'&nbsp;'.'&nbsp;'."ชั้นมัธยมศึกษาปีที่".'&nbsp;'."$class_id".'&nbsp;'."/".'&nbsp;'."$room".'&nbsp;'."เลขที่".'&nbsp;'."$no";?></b></font><br>&nbsp;&nbsp;<img src="images/horz_1.gif"></td>
          </tr>
        </table>
...
<?php		
		...
		$sql	  = "SELECT * FROM tb_newupdate where status_new ='2' order by new_id DESC";
...
?>
<?php
	if($status_new == 2)	//เงื่อนไขตรวจสอบสถานะข่าว
	{
?>
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse;">
  <tr>
          ...
          <tr>
            ...
            <td height="50" valign="middle"><div id="mylayout_b"><font size="3"><b>รายละเอียด</b>&nbsp;<?php echo nl2br($result["det_new"]);?></font></div><br></td>
            <td height="50" valign="middle">&nbsp;</td>
          </tr>
          <tr>
...
?> 
<?php
	}if($status_new != 2){	//ไม่เท่ากับ สถานะ 2
