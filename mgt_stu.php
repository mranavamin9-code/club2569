...
?>
<div class="main">
<form method="get" name="form_search_cus" action="det_mgt_stu.php" target="_blank">
  <table width="60%" border="1" align="center" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
    <tr>
      <td><table width="100%" border="1" bordercolor="#FFFFFF" cellspacing="0" cellpadding="0" style="border-collapse:collapse;">
          <tr>
            <td height="35" align="center" bgcolor="#D8D8D8"><font size="5" color="#FF6600" face="MS Sans Serif, Tahoma, sans-serif"><b>จัดการข้อมูลนักเรียนเพิ่มเติม</b></font></td>
          </tr>
          <tr>
